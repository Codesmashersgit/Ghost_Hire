    ...
    <div className="min-h-screen bg-bg-primary flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-bg-secondary/50 backdrop-blur-xl border border-black/10 rounded-3xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-xs font-semibold text-text-tertiary uppercase tracking-wider">Password</label>
        ...
        <p className="text-center text-sm text-text-secondary mt-6">
          ...
          <Link to="/signup" className="text-primary-light hover:underline font-semibold">Sign Up</Link>
        </p>
      </div>
    </div>
  );
